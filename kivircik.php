...
<head>
    ...
    <title>Kıvırcık Saç Bakım Önerileri</title>
    <link rel="stylesheet" href="style.css?v=<?php echo time(); ?>">
    <script src="script.js" defer></script>
</head>
<body class="kivircik_bg">
    ...
    <div class="content-detay">
        <h1>Kıvırcık Saç Bakım Önerileri</h1>

        <?php if (isset($kivircik_sac) && !empty($kivircik_sac)): ?>
            <ul class="sac-onerileri-list">
                <?php foreach ($kivircik_sac as $oneriler): ?>
                    <li>
